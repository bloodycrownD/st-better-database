...
import {useSystemServices} from '@/app/composables/screens-composables/useServices.ts';
...
const {dataManagementService, tableManagementService, sqlExecutorService} = useSystemServices();
